<?php
    ...
    include '../../includes/comments.inc3.php';
    session_start();
?>
    ...
    <div class="container-fluid"> 
     <div class="sep">
        <div class="row">
            ...
            <iframe src="https://www.youtube.com/embed/fWjsdhR3z3c"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 18pt; font-weight: semi-bold;">Learn Python in Less than 10 Minutes for Beginners (Fast & Easy)</p>
            ...
            <div class="bot-sec">
            <a href="pyvid2.php">
              <img src="../../assets/images/py3.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">Harvard CS50â€™s Introduction to Programming with Python â€“ Full University Course</p>
