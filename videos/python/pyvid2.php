<?php
    ...
    include '../../includes/comments.inc2.php';
    session_start();
?>
    ...
    <div class="container-fluid"> 
     <div class="sep">
        <div class="row">
            ...
            <iframe src="https://www.youtube.com/embed/nLRL_NcnK-4"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 18pt; font-weight: semi-bold;">Harvard CS50â€™s Introduction to Programming with Python â€“ Full University Course</p>
            <p id="by">by Harvard University and arranged by freeCodeCamp.org | May 1, 2023</p>
            <br><br>
            <?php
            if (isset($_SESSION['id'])){
            ...
            <div class="bot-sec">
            <a href="pyvid1.php">
              <img src="../../assets/images/py2.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">Python for Beginners â€“ Full Course [Programming Tutorial]</p>
                <p id="by">by freeCodeCamp.org | Aug 9, 2022</p>
            </a>
            </div>
            <br>
            <br>
            <div class="bot-sec">
            <a href="pyvid.php">
              <img src="../../assets/images/py1.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">Learn Python in Less than 10 Minutes for Beginners (Fast & Easy)</p>
              <p id="by">by Indently</p>
            </a>
            </div>
        </div>
    </div>
