<?php
    ...
    include '../../includes/comments.inc11.php';
    session_start();
?>
    ...
    <div class="container-fluid"> 
     <div class="sep">
        <div class="row">
            ...
            <iframe src="https://www.youtube.com/embed/zZ6vybT1HQs"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 18pt; font-weight: semi-bold;">PHP Full Course for non-haters ðŸ˜ (2023)</p>
            ...
            <div class="bot-sec">
            <a href="phpvid1.php">
              <img src="../../assets/images/php1.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">Learn PHP in 15 minutes</p>
