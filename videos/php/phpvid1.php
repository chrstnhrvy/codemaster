<?php
    ...
    include '../../includes/comments.inc10.php';
    session_start();
?>
    ...
    <div class="container-fluid"> 
     <div class="sep">
        <div class="row">
            ...
            <iframe src="https://www.youtube.com/embed/ZdP0KM49IVk"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 18pt; font-weight: semi-bold;">Learn PHP in 15 minutes</p>
            <p id="by">by Jake Wright | Jan 16, 2013</p>
            <br><br>
            <?php
            if (isset($_SESSION['id'])){
            ...
            <div class="bot-sec">
            <a href="phpvid2.php">
              <img src="../../assets/images/php2.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">PHP Full Course for non-haters ðŸ˜ (2023)</p>
              <p id="by">by Bro Code | Mar 29, 2023</p>
            </a>
            </div>
            <br>
            <br>
            <div class="bot-sec">
            <a href="phpvid3.php">
              <img src="../../assets/images/php3.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">PHP For Beginners - Complete Laracasts Course</p>
              <p id="by">by Laracasts | Nov 21, 2023</p>
            </a>
            </div>
        </div>
    </div>
