    ...
    <div class="container-fluid"> 
     <div class="sep">
        <div class="row">
            ...
            <iframe src="https://www.youtube.com/embed/LO5eTH4Pe8E"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 18pt; font-weight: semi-bold;">JavaScript In 10 Minutes | JavaScript Tutorial For Beginners | Learn JavaScript | Simplilearn</p>
            ...
            <div class="bot-sec">
            <a href="jsvid1.php">
              <img src="../../assets/images/js1.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">JavaScript Tutorial for Beginners: Learn JavaScript in 1 Hour</p>
