<?php
    ...
    include '../../includes/comments.inc5.php';
    session_start();
?>
    ...
    <div class="container-fluid"> 
     <div class="sep">
        <div class="row">
            ...
            <iframe src="https://www.youtube.com/embed/wRNinF7YQqQ"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 18pt; font-weight: semi-bold;">Learn CSS in 1 hour ðŸŽ¨</p>
            ...
            <div class="bot-sec">
            <a href="cssvid3.php">
              <img src="../../assets/images/css3.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">Learn CSS in 20 Minutes</p>
