<?php
    ...
    include '../../includes/comments.inc6.php';
    session_start();
?>
    ...
    <div class="container-fluid"> 
     <div class="sep">
        <div class="row">
            ...
            <iframe src="https://www.youtube.com/embed/1PnVor36_40"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 18pt; font-weight: semi-bold;">Learn CSS in 20 Minutes</p>
            <p id="by">by Web Dev Simplified | Aug 23, 2018</p>
            <br><br>
            <?php
            if (isset($_SESSION['id'])){
            ...
            <div class="bot-sec">
            <a href="cssvid1.php">
              <img src="../../assets/images/css1.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">Learn CSS in 1 hour ðŸŽ¨</p>
              <p id="by">by Bro Code | Sep 8, 2021</p>
            </a>
            </div>
            <br>
            <br>
            <div class="bot-sec">
            <a href="cssvid2.php">
              <img src="../../assets/images/css2.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">CSS Tutorial â€“ Full Course for Beginners</p> 
              <p id="by">by freeCodeCamp.org | Aug 30, 2022</p>
            </a>
            </div>
        </div>
    </div>
