<?php
    ...
    include '../../includes/comments.inc15.php';
    session_start();
?>
    ...
    <div class="container-fluid"> 
     <div class="sep">
        <div class="row">
            ...
            <iframe src="https://www.youtube.com/embed/GlGpSQsS8uc"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 18pt; font-weight: semi-bold;">Learn C# â€“ Full Course with Mini-Projects</p>
            ...
            <div class="bot-sec">
            <a href="csharpvid1.php">
              <img src="../../assets/images/c1.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">C# Tutorial For Beginners - Learn C# Basics in 1 Hour</p>
