<?php
    ...
    include '../../includes/comments.inc14.php';
    session_start();
?>
    ...
    <div class="container-fluid"> 
     <div class="sep">
        <div class="row">
            ...
            <iframe src="https://www.youtube.com/embed/gfkTfcpWqAY"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 18pt; font-weight: semi-bold;">C# Full Course for free ðŸŽ®</p>
            ...
            <a href="csharpvid1.php">
              ...
              <p id="by">by Programming with Mosh | Apr 3, 2016</p>
            </a>
            </div>
            <br>
            <br>
