<?php
    ...
    include '../../includes/comments.inc13.php';
    session_start();
?>
    ...
    <div class="container-fluid"> 
     <div class="sep">
        <div class="row">
            ...
            <iframe src="https://www.youtube.com/embed/wxznTygnRfQ"  frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" referrerpolicy="strict-origin-when-cross-origin" allowfullscreen></iframe>
            <p style="font-size: 18pt; font-weight: semi-bold;">C# Tutorial For Beginners - Learn C# Basics in 1 Hour</p>
            <p id="by">C# Tutorial For Beginners - Learn C# Basics in 1 Hour</p>
            <br><br>
            <?php
            if (isset($_SESSION['id'])){
            ...
            <div class="bot-sec">
            <a href="csharpvid2.php">
              <img src="../../assets/images/c2.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">C# Full Course for free ðŸŽ®</p>
              <p id="by">by Bro Code | Jul 5, 2021</p>
            </a>
            </div>
            <br>
            <br>
            <div class="bot-sec">
            <a href="csharpvid3.php">
              <img src="../../assets/images/c3.jpg" height="275" alt="Description of Image">
              <p style="font-size: 12pt;">Learn C# â€“ Full Course with Mini-Projects</p>
              <p id="by">by CoffeNCode | Mar 4, 2024</p>
            </a>
            </div>
        </div>
    </div>
